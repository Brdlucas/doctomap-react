      ...
      <nav className="text-sm text-gray-300">
        <ul className="flex flex-col">
          <li className="px-4 cursor-pointer bg-gray-500 text-gray-800 hover:bg-gray-700  hover:text-white">
            <NavLink className="py-3 flex items-center" to="/dashboard">
              <svg
          ...
          <li className="px-4 cursor-pointer hover:bg-gray-700">
            <NavLink className="py-3 flex items-center" to="/dashboard/users">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
          ...
          <li className="px-4 cursor-pointer hover:bg-gray-700">
            <NavLink className="py-3 flex items-center" to="users">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
